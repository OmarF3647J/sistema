<template>
  <aside class="z-20 w-64 overflow-y-auto bg-white flex-shrink-0">
          ...
          <button @click="toggleMenu('centros')"
              ...
              aria-haspopup="true">
                <span class="inline-flex items-center">
                    ...
                    <span class="ml-4">Centros Turísticos</span>
                </span>
            ...
            <ul v-if="showingCentrosMenu"
              class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50" aria-label="submenu">
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      // Agregamos una validación para evitar errores si 'route' no está listo
      if (typeof route !== 'undefined') {
        ...
        if (current) {
          ...
          if (current.startsWith('producto')) showingProductoMenu.value = true
        }
      }
    });
